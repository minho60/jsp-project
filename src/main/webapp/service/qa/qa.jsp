...
<link rel="icon"
	href="<%=request.getContextPath()%>/assets/img/main/favicon.png"
	type="image/x-icon" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/css/layout.css" />
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/assets/css/service/qa_new.css">
...
그 밖의 사항은 도드람양돈협동조합의 개인정보취급방침을 준수합니다.</textarea>
									<div class="qa-check-box">
										<input type="checkbox"><label for="">비회원 글작성에
											대한 개인정보 수집 및 이용동의 </label><a href="/service/qa/qa_private.html">전체보기></a>
									</div>
									<div class="qa-btn">
